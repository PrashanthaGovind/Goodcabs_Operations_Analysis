...
Goodcabs, a leading cab service in tier-2 Indian cities, aims to evaluate its 2024 performance across key metrics such as trip volume, passenger satisfaction, repeat passenger rate, and trip distribution. Due to an urgent request from the Chief of Operations, the analysis has been assigned to a data analyst.

# Live Dashboard Link
[View Dashboard](https://app.powerbi.com/view?r=eyJrIjoiNmNjZTMxNDItMWQ5Yy00NTM1LTk5NzMtYjQ3OGNiOTRhZDVjIiwidCI6IjY5NjcwYTUzLTY5MWEtNDBkZi1hM2I3LTU5MDdmYjdkY2U2YyJ9)
